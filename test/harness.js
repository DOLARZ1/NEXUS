...
["dashboard", "habits", "finance", "tasks", "workouts", "goals", "focus", "nutrition", "health"].forEach((v) => reg("view-" + v, makeEl("section")));

const bootBar = makeEl("span");
byId["boot-screen"].appendChild(bootBar);

// tabs y theme buttons
const tabEls = ["dashboard", "habits", "finance", "tasks", "workouts", "goals", "focus", "nutrition", "health"].map((v) => { const t = makeEl("button"); t.dataset.view = v; t.classList.add("tab"); if (v === "dashboard") t.classList.add("is-active"); return t; });
...
const document = {
  ...
  querySelectorAll: (sel) => {
    ...
    if (sel === ".view") return ["dashboard", "habits", "finance", "tasks", "workouts", "goals", "focus", "nutrition", "health"].map((v) => byId["view-" + v]);
    return [];
  },
  addEventListener: () => {}
};
...
["dashboard", "habits", "finance", "tasks", "workouts", "goals", "focus", "nutrition", "health"].forEach((v) => {
